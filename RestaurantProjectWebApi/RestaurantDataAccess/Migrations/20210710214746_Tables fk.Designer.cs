...
namespace RestaurantDataAccess.Migrations
{
    ...
    [Migration("20210710214746_Tables fk")]
    partial class Tablesfk
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RestaurantDataAccess.Models.CheckReservation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("CheckReservations");
                });

            modelBuilder.Entity("RestaurantDataAccess.Models.Contact", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("RestaurantDataAccess.Models.Menu", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("RestaurantDataAccess.Models.Menu", b =>
                {
                    b.HasOne("RestaurantDataAccess.Models.Category")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("RestaurantDataAccess.Models.Review", b =>
                {
                    b.HasOne("RestaurantDataAccess.Models.Menu")
                        .WithMany("Reviews")
                        .HasForeignKey("Id")
                        .OnDelete(DeleteBehavior.Cascade);
